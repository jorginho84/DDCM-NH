...
keep total_income_y* gross_y* gross_nominal_y* grossv2_y* employment_y* sampleid ra_year afdc_y* fs_y*
reshape long total_income_y gross_y gross_nominal_y grossv2_y employment_y afdc_y fs_y, i(sampleid) j(year)
...
keep year_ra total_income_y sampleid gross_y gross_nominal_y grossv2_y employment_y afdc_y fs_y
reshape wide total_income_y gross_y gross_nominal_y grossv2_y employment_y afdc_y fs_y, i(sampleid) j(year_ra)
