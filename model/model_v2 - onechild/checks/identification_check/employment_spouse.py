...
ax.legend()
ax.set_ylabel(r'Observed employment rate',fontsize=font_size)
ax.set_xlabel(r'Probit coefficient',fontsize=font_size)
...
ax.legend(loc=0)
plt.show()
fig.savefig('/home/jrodriguez/NH_HC/results/model_v2/checks/empoyment_spouse.pdf', format='pdf')
plt.close()
