...
lenght = 1
size_grid = 6
max_p = wagep_betas[1] + 0.03
min_p = wagep_betas[1] - 0.03
...
ax.legend()
ax.set_ylabel(r'Trend coefficient of wage regression',fontsize=font_size)
ax.set_xlabel(r'Trend coefficient of wage offer process',fontsize=font_size)
...
ax.legend(loc=0)
plt.show()
fig.savefig('/home/jrodriguez/NH_HC/results/model_v2/checks/logt_wage.pdf', format='pdf')
plt.close()
