...
betas_nelder=np.load('/home/jrodriguez/NH_HC/results/Model/estimation/betas_modelv52.npy')
var_cov=np.load('/home/jrodriguez/NH_HC/results/model_v2/estimation/sesv3_modelv52.npy')
