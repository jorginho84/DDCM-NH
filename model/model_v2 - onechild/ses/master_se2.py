"""
exec(open("/home/jrodriguez/NH_HC/codes/model_v2/ses/master_se2.py").read())
...
betas_opt = np.array([eta, alphap,alphaf,wagep_betas[0,0],
	...
	c_emp_spouse,
	gamma1,gamma2,gamma3,tfp,rho_theta_epsilon])



#The SE class
se_ins = se_2.SEs(output_ins,var_cov,betas_opt)
...
np.save('/home/jrodriguez/NH_HC/results/model_v2/estimation/sesv4_modelv41.npy',ses['Var_Cov']*(1+1/M))
