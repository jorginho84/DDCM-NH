...
plot3=ax.plot(np.full((size_grid,),gamma1[0][1]),target_moment,'k--',label='Estimated parameter',alpha=0.9)
...
plt.show()
fig.savefig('/mnt/Research/nealresearch/new-hope-secure/newhopemount/results/Model/checks/gamma1_young_cc1.pdf', format='pdf')
plt.close()
