...
ax.legend()
ax.set_ylabel(r'High school coefficient of observed wage regression',fontsize=font_size)
ax.set_xlabel(r'High school coefficient of wage offer process',fontsize=font_size)
...
ax.legend(loc=0)
plt.show()
fig.savefig('/mnt/Research/nealresearch/new-hope-secure/newhopemount/results/Model/checks/highschool_wage.pdf', format='pdf')
plt.close()
