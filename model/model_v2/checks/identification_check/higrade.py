...
ax.legend()
ax.set_ylabel(r'Highest grade coefficient of wage regression',fontsize=font_size)
ax.set_xlabel(r'Highest grade of wage offer process',fontsize=font_size)
...
ax.legend(loc=0)
plt.show()
fig.savefig('/mnt/Research/nealresearch/new-hope-secure/newhopemount/results/Model/checks/higrade.pdf', format='pdf')
plt.close()
