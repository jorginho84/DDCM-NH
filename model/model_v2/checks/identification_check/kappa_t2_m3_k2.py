...
lenght = 1
size_grid = 4
max_p = kappas[0][2][1] + lenght
min_p = kappas[0][2][1] - lenght
...
for i in range(size_grid): 
	...
	target_moment[i] = np.mean(dic_betas['beta_kappas_t2'],axis=2)[1][2] #The matrix is 4x3
...
plot3=ax.plot(np.full((size_grid,),kappas[0][2][1]),target_moment,'k--',label='Estimated parameter',alpha=0.9)
