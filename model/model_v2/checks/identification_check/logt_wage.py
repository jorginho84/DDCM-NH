...
ax.legend()
ax.set_ylabel(r'$\log(t)$ coefficient of observed wage regression',fontsize=font_size)
ax.set_xlabel(r'$\log(t)$ coefficient of wage offer process',fontsize=font_size)
