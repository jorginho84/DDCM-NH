"""
execfile('master_estimate_bas.py')
...
import estimate_bas as estimate
...
np.save('/mnt/Research/nealresearch/new-hope-secure/newhopemount/results/betas_modelv2_nelder_bas_v1.npy',betas_opt)
