"""
This file tests mean equality between treatment and control groups using
bootstrap.
...
list_sample = [boo_all,boo_unemp,boo_emp,boo_young,boo_old]
list_sample_label = ['All','Unemployed at baseline','Employed at baseline','Young','Old']
