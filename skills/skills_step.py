...
#samples
samples = ['all','young','old']

for x in range(3):

	####Skills estimates###
	dofile = "/mnt/Research/nealresearch/new-hope-secure/newhopemount/codes/skills/skills_"+samples[x]+".do"
	...
	with open('/mnt/Research/nealresearch/new-hope-secure/newhopemount/results/Skills/Y2_pvalues_'+samples[x]+'.tex','w') as f:
