...
foreach sex in "Overall" "Girls" "Boys"{
	...
	*the table
	putexcel B2=matrix(baseline) using "$results/Skills/skills_Y2_`sex'", sheet("data") modify
	local number=2
	...
	*/ "CBS: Behavior skills" "CBS: Independent skills" "CBS: Transitional skills" {
	...
	putexcel B1=("Treatment") using "$results/Skills/skills_Y2_`sex'", sheet("data") modify
	putexcel C1=("Control") using "$results/Skills/skills_Y2_`sex'", sheet("data") modify
	putexcel D1=("Impact 1") using "$results/Skills/skills_Y2_`sex'", sheet("data") modify
	putexcel E1=("p-value") using "$results/Skills/skills_Y2_`sex'", sheet("data") modify
	*putexcel F1=("N") using "$results/Skills/skills_Y2_`sex'", sheet("data") modify
...
foreach sex in "Overall" "Girls" "Boys"{
	...
	*the table
	putexcel B2=matrix(baseline) using "$results/Skills/skills_Y2_probit_`sex'", sheet("data") modify
	local number=2
	foreach x in "SSRS: Overall" "SSRS: Reading" "SSRS: Math" "SSRS: Reading grade expectations" "SSRS: Math grade expectations"/* 
	*/ "SSRS: Motivation" "SSRS: Parental encouragement" "SSRS: Intellectual functioning" "SSRS: Classroom behavior" "SSRS: Communication skills"/*
	*/ "CBS: Behavior skills" "CBS: Independent skills" "CBS: Transitional skills"  {
	...
	putexcel B1=("Treatment") using "$results/Skills/skills_Y2_probit_`sex'", sheet("data") modify
	putexcel C1=("Control") using "$results/Skills/skills_Y2_probit_`sex'", sheet("data") modify
	putexcel D1=("Impact 1") using "$results/Skills/skills_Y2_probit_`sex'", sheet("data") modify
	putexcel E1=("p-value") using "$results/Skills/skills_Y2_probit_`sex'", sheet("data") modify
	*putexcel F1=("N") using "$results/Skills/skills_Y2_probit_`sex'", sheet("data") modify
