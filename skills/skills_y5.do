...
foreach sex in "Overall" "Girls" "Boys"{
	...
	*the table
	putexcel B2=matrix(baseline) using "$results/Skills/skills_Y5_`sex'", sheet("data") modify
	local number=2
	...
	*/{
	...
	putexcel B1=("Treatment") using "$results/Skills/skills_Y5_`sex'", sheet("data") modify
	putexcel C1=("Control") using "$results/Skills/skills_Y5_`sex'", sheet("data") modify
	putexcel D1=("Impact 1") using "$results/Skills/skills_Y5_`sex'", sheet("data") modify
	putexcel E1=("p-value") using "$results/Skills/skills_Y5_`sex'", sheet("data") modify
	*putexcel F1=("N") using "$results/Skills/skills_Y5_`sex'", sheet("data") modify
...
foreach sex in "Overall" "Girls" "Boys"{
	...
	*the table
	putexcel B2=matrix(baseline) using "$results/Skills/skills_Y5_probit_`sex'", sheet("data") modify
	local number=2
	foreach x in "WJ: Letter-Word" "WJ: Comprehension" "WJ: Calculation" "WJ: Applied problems" /* WJ
	*/ "SSRS: Overall" "SSRS: Reading" "SSRS: Math" "SSRS: Reading grade expectations" "SSRS: Math grade expectations" "SSRS: Motivation" "SSRS: Parental encouragement" /* SSRS
	*/ "SSRS: Intellectual functioning" "SSRS: Class behavior" "SSRS: Communication skills"/* SSRS
	...
	*/{
	...
	putexcel B1=("Treatment") using "$results/Skills/skills_Y5_probit_`sex'", sheet("data") modify
	putexcel C1=("Control") using "$results/Skills/skills_Y5_probit_`sex'", sheet("data") modify
	putexcel D1=("T-C") using "$results/Skills/skills_Y5_probit_`sex'", sheet("data") modify
	putexcel E1=("p-value") using "$results/Skills/skills_Y5_probit_`sex'", sheet("data") modify
	*putexcel F1=("N") using "$results/Skills/skills_Y5_probit_`sex'", sheet("data") modify
