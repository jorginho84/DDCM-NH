...
foreach sex in "Overall" "Girls" "Boys"{
	...
	*the table
	putexcel F2=matrix(baseline) using "$results/Skills/skills_Y8_`sex'", sheet("data") modify
	local number=2
	...
	*/{
	...
	putexcel F1=("Impact 2") using "$results/Skills/skills_Y8_probit_`sex'", sheet("data") modify
	putexcel G1=("p-value") using "$results/Skills/skills_Y8_probit_`sex'", sheet("data") modify
...
foreach sex in "Overall" "Girls" "Boys"{
	...
	*the table
	putexcel F2=matrix(baseline) using "$results/Skills/skills_Y8_probit_`sex'", sheet("data") modify
	local number=2
	foreach x in "WJ: Letter-Word" "WJ: Comprehension" "WJ: Applied problems" /* WJ
	*/ "SSRS: Overall" "SSRS: Reading" "SSRS: Math" "SSRS: Reading grade expectations" "SSRS: Math grade expectations" "SSRS: Motivation" "SSRS: Parental encouragement" /* SSRS
	*/ "SSRS: Intellectual functioning" "SSRS: Class behavior" "SSRS: Communication skills"/* SSRS
